...
const TasksToDo = computed(() =>
    todos.value.filter((todo) => todo.tags.status === "To Do" && todo.tags.department === "Legal security & control")
);

const TasksInProgress = computed(() =>
    todos.value.filter((todo) => todo.tags.status === "In Progress" && todo.tags.department === "Legal security & control")
);
