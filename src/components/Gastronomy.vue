...
const TasksToDo = computed(() =>
    todos.value.filter((todo) => todo.tags.status === "To Do" && todo.tags.department === "Gastronomy")
);

const TasksInProgress = computed(() =>
    todos.value.filter((todo) => todo.tags.status === "In Progress" && todo.tags.department === "Gastronomy")
);
