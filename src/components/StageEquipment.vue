...
const TasksToDo = computed(() =>
    todos.value.filter((todo) => todo.tags.status === "To Do" && todo.tags.department === "Stage & equipment")
);

const TasksInProgress = computed(() =>
    todos.value.filter((todo) => todo.tags.status === "In Progress" && todo.tags.department === "Stage & equipment")
);

const TasksDone = computed(() =>
    todos.value.filter((todo) => todo.tags.status === "Done" && todo.tags.department === "Stage & equipment")
);
