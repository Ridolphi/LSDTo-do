...
const TasksToDo = computed(() =>
    todos.value.filter((todo) => todo.tags.status === "To Do" && todo.tags.department === "Ticketing & pre-sale")
);

const TasksInProgress = computed(() =>
    todos.value.filter((todo) => todo.tags.status === "In Progress" && todo.tags.department === "Ticketing & pre-sale")
);

const TasksDone = computed(() =>
    todos.value.filter((todo) => todo.tags.status === "Done" && todo.tags.department === "Ticketing & pre-sale")
);
