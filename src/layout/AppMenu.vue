...
const model = ref([
    ...
    },
    {
        label: 'Organization',
        items: [
            { label: 'All departments', icon: 'pi pi-fw pi-sitemap', to: '/uikit/formlayout' },
            { label: 'Artist bookings', icon: 'pi pi-fw pi-microphone', to: '/uikit/input' },
            { label: 'Gastronomy', icon: 'pi pi-fw pi-cart-plus', to: '/uikit/floatlabel' },
            { label: 'Legal, security & control', icon: 'pi pi-fw pi-shield', to: '/uikit/invalidstate' },
